...
const defaultLayoutOptions = {
     ...
     *
     * @see https://www.eclipse.org/elk/reference/options/org-eclipse-elk-directiondirection.html
     */
    'elk.direction': 'DOWN',
...
// function mapEdge({ edge: { data, ...edge }, direction }) {
...
export const elkLayout = (nodes, edges, options) => {
    const graph = new ELK();
    const layoutOptions = {
